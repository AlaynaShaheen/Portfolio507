        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#coding-profiles" className={activeLink === 'coding-profiles' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('coding-profiles')}>Coding Profiles</Nav.Link>
